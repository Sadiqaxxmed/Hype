...
import { thunkUserOutfits } from "../../store/outfit";
...
function ProfilePage(){
    ...
    const outfits = Object.values(useSelector(state => state.outfits.userOutfits));
    ...
    useEffect(() => {   
        dispatch(thunkUserOutfits(user.id))
    }, [dispatch])
    ...
    return (
        ...
        <img src={user?.profile_image} className="PP-Profile-Img"></img>
        <div className="PP-Profile-Info">
            ...
            <button className="PP-Subscribe-Button">Subscribe</button>
        </div>
        </div>
